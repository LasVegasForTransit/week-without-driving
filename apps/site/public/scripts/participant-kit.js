 ...
 *     real browser permission or sending a real text. task
 *     "Send daily reminders by web push" and
 *     "Send daily reminders by text message"
 *     wire these up for real.
 *   - "Join the newsletter" shows the same success message the finished
 *     Beehiiv sign-up will show. task
 *     "Subscribe participants to LVBT's newsletter through Beehiiv"
 * and "Build the 'Keep going after the
 *     week' card…" connect it for real.
 */
(() => {
